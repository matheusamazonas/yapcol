...
fn fail_not_consuming() {
	...
	assert_eq!(any()(&mut input), Ok("other")); // Ensure that the input was NOT consumed.
}
...
fn fail_consuming() {
	...
	assert_eq!(any()(&mut input), Ok("hollo")); // Ensure that the input was consumed.
}
